    ...
    public function boot(): void
    {
        Gate::define('gateAll', function(User $user){
            ...
            $routeAll = collect([
                ...
                'produkList'=>['produk.list', 'produk.list.produk','produk.detail'],
                ...
                'pesananSumberList'=>['pesanan.sumber.list', 'pesanan.sumber.detail'],
                ...
                'subscribe'=>['subcribe.list', 'subcribe.add.proses'],
            ]);
