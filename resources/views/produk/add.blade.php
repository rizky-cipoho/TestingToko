<x-guest-layout>
	...
	<div class="page-body" style="margin-top:0px;">
		...
		<form action="{{ route('produk.edit.proses', $id) }}" method="POST" enctype="multipart/form-data">
			...
			<form action="{{ route('produk.add.proses') }}" method="POST" enctype="multipart/form-data">
																...
																<div id="imageproduk" style="position:relative;">
																	...
																	<li style="float: left; margin: 5px; position:relative;">
																		<div class="box-input-file" style="width: 100px; height:100px;">
																			...
																			<input class="upload" name="gambar_produk[{{$index}}][gambar]" type="file" onchange="preview_image('output_image[{{$index}}]' ,event)" style="width:100px; height:100px;  z-index: 999; cursor:pointer;">
																			<input type="text" name="gambar_produk[{{$index}}][id]" style="display:none;" value="{{ $image->id }}">
																			<i class="fa fa-plus" style="position: absolute;"></i></div>
																		</li>
																		@endforeach
																		@else
																		<li style="float: left; margin: 5px; position:relative;">
																			<div class="box-input-file" style="width: 100px; height:100px;">
																				...
																				<input class="upload" name="gambar_produk[0]" type="file" onchange="preview_image('output_image[0]',event)" style="width:100px; height:100px;  z-index: 999; cursor:pointer;"><i class="fa fa-plus" style="position: absolute;"></i></div>
																			</li>
																			@endif
																		</div>
															...
															<div class="form">
																<div class="form-group mb-3 row">
																	...
																	<div class="col-xl-9 col-sm-7">
																		<input class="form-control" name="judul_id" id="validationCustom01" type="text" placeholder="Title ID" required="" value="{{ old('judul_id') ? old('judul_id') : (isset($produk) ? $produk->judul_id : '') }}">
																		<input class="form-control" name="judul_en" id="validationCustom01" type="text" placeholder="Title EN" required="" style="margin-top: 10px;" value="{{ old('judul_en') ? old('judul_en') : (isset($produk) ? $produk->judul_en : '') }}">
																	</div>
																	...
																	<div class="col-xl-9 col-sm-7">
																		<div class="row">
																			<div class="col-xl-6 col-sm-7">
																				<input placeholder="Price ID" name="harga_id" class="form-control" id="validationCustom02" type="text" required="" value="{{ old('harga_id') ? old('harga_id') : (isset($produk) ? $produk->harga_id : '') }}">
																				<input placeholder="Price EN" name="harga_en" class="form-control" id="validationCustom02" type="text" required="" style="margin-top: 10px;" value="{{ old('harga_en') ? old('harga_en') : (isset($produk) ? $produk->harga_en : '') }}">
																			</div>
																			<div class="col-xl-6 col-sm-7">
																				<input placeholder="Sale Price ID" name="diskon_id" class="form-control" id="validationCustom02" type="text" required="" value="{{ old('diskon_id') ? old('diskon_id') : (isset($produk) ? $produk->diskon_id : '') }}">
																				<input placeholder="Sale Price EN" name="diskon_en" class="form-control" id="validationCustom02" type="text" required="" style="margin-top: 10px;" value="{{ old('diskon_en') ? old('diskon_en') : (isset($produk) ? $produk->diskon_en : '') }}">
																			</div>
																			<div class="col-xl-6 col-sm-7 mt-2">
																				<input placeholder="Modal" name="modal_id" class="form-control" id="validationCustom02" type="text" required="" value="{{ old('modal_id') ? old('modal_id') : (isset($produk) ? $produk->modal_id : '') }}">
																				<input placeholder="Modal" name="modal_en" class="form-control" id="validationCustom02" type="text" required="" style="margin-top: 10px;" value="{{ old('modal_en') ? old('modal_en') : (isset($produk) ? $produk->modal_en : '') }}">
																			</div>
																		</div>
																	</div>
																	<div class="valid-feedback">Looks good!</div>
																...
																<div class="form-group mb-3 row">
																	...
																	<div class="col-xl-9 col-sm-7">
																		<input class="form-control" name="kode_sku" placeholder="SKU Code" id="validationCustomUsername" type="text" required="" value="{{ old('kode_sku') ? old('kode_sku') : (isset($produk) ? $produk->kode_sku : '') }}">
																	</div>
																...
																<div class="form-group mb-3 row">
																	...
																	<div class="col-md-9" >
																		...
																		<div id="warna">
																			<div class="row" >
																				<div class="col-xl-4 col-sm-7">
																					<input class="form-control" name="warna[{{ $index }}][warna]" id="validationCustomUsername" placeholder="Judul Warna" type="text" required="" value="{{ old('warna['.$index.'][warna]') ? old('warna['.$index.'][warna]') : $warna->warna }}">
																				</div>
																				<div class="col-xl-3 col-sm-7">
																					<input class="form-control" name="warna[{{ $index }}][kode_warna]" id="validationCustomUsername" placeholder="Kode Warna" type="text" required="" value="{{ old('warna['.$index.'][kode_warna]') ? old('warna['.$index.'][kode_warna]') : $warna->kode_warna }}">
																				</div>
																				<div class="col-xl-3 col-sm-7">
																					<input class="form-control" name="warna[{{ $index }}][gambar_warna]" id="validationCustomUsername" type="file" @if(!isset($produk)) required @endif>
																				</div>
																				<div class="col-xl-2 col-sm-7">
																					<select class="form-control" name="warna[{{ $index }}][status_warna]" id="validationCustomUsername" type="text" required="">
																		...
																		<div id="warna">
																			<div class="row" >
																				<div class="col-xl-4 col-sm-7">
																					<input class="form-control" name="warna[0][warna]" id="validationCustomUsername" placeholder="Judul Warna" type="text" required="" value="{{ old('warna[0][warna]') ? old('warna[0][warna]') : '' }}">
																				</div>
																				<div class="col-xl-3 col-sm-7">
																					<input class="form-control" name="warna[0][kode_warna]" id="validationCustomUsername" placeholder="Kode Warna" type="text" required="" value="{{ old('warna[0][kode_warna]') ? old('warna[0][kode_warna]') : '' }}">
																				</div>
																				<div class="col-xl-3 col-sm-7">
																					<input class="form-control" name="warna[0][gambar_warna]" id="validationCustomUsername" type="file" @if(!isset($produk)) required @endif>
																				</div>
																				<div class="col-xl-2 col-sm-7">
																					<select class="form-control" name="warna[0][status_warna]" id="validationCustomUsername" type="text" required="">
																						<option value="Ready" {{ old('warna[0][status_warna]') == 'Ready' ? 'selected' : '' }}>Ready</option>
																						<option value="Sold Out" {{ old('warna[0][status_warna]') == 'Sold Out' ? 'selected' : '' }}>Sold Out</option>
																					</select>
																				</div>
																				<div style="margin-bottom:10px; display: block; width: 100%;"></div>
																			</div>
																...
																<div class="form-group mb-3 row">
																	...
																	<div class="col-md-9" >
																		...
																		<div id="size">
																			<div class="row" >
																				<div class="col-xl-4 col-sm-7">
																					<input class="form-control" name="size[{{$index}}][size_id]" id="validationCustomUsername" placeholder="Size ID" type="text" required="" value="{{ old('size['.$index.'][size_id]') ? old('size['.$index.'][size_id]') : $ukuran->ukuran_id }}">
																				</div>
																				<div class="col-xl-4 col-sm-7">
																					<input class="form-control" name="size[{{$index}}][size_en]" id="validationCustomUsername" placeholder="Size EN" type="text" required="" value="{{ old('size['.$index.'][size_en]') ? old('size['.$index.'][size_en]') : $ukuran->ukuran_en }}">
																				</div>
																				<div class="col-xl-4 col-sm-7">
																					<select class="form-control" name="size[{{$index}}][status_size]" id="validationCustomUsername" type="text" required="">
																		...
																		<div id="size">
																			<div class="row" >
																				<div class="col-xl-4 col-sm-7">
																					<input class="form-control" name="size[0][size_id]" id="validationCustomUsername" placeholder="Size ID" type="text" required="" value="{{ old('size[0][size_id]') ? old('size[0][size_id]') : '' }}">
																				</div>
																				<div class="col-xl-4 col-sm-7">
																					<input class="form-control" name="size[0][size_en]" id="validationCustomUsername" placeholder="Size EN" type="text" required="" value="{{ old('size[0][size_en]') ? old('size[0][size_en]') : '' }}">
																				</div>
																				<div class="col-xl-4 col-sm-7">
																					<select class="form-control" name="size[0][status_size]" id="validationCustomUsername" type="text" required="">
																						<option value="Aktif" {{ old('size[0][status_size]') == 'Ready' ? 'selected' : '' }}>Aktif</option>
																						<option value="Tidak Aktif" {{ old('size[0][status_size]') == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
																					</select>
																				</div>
																				<div style="margin-bottom:10px; display: block; width: 100%;"></div>
																...
																<div class="form-group mb-3 row">
																	...
																	<div class="col-md-9" >
																		...
																		<div id="link">
																			<div class="row" >
																				<div class="col-xl-3 col-sm-7">
																					<input class="form-control" name="link[{{$index}}][judul_link]" id="validationCustomUsername" placeholder="Text Tombol" type="text" required="" value="{{ old('link['.$index.'][judul_link]') ? old('link['.$index.'][judul_link]') : $link->judul_link }}">
																				</div>
																				<div class="col-xl-4 col-sm-7">
																					<input class="form-control" name="link[{{$index}}][link]" id="validationCustomUsername" placeholder="Link Tujuan" type="text" required="" value="{{ old('link['.$index.'][judul_link]') ? old('link['.$index.'][judul_link]') : $link->link }}">
																				</div>
																				<div class="col-xl-3 col-sm-7">
																				...
																				<div class="col-xl-2 col-sm-7">
																					<select class="form-control" name="link[{{$index}}][status_link]" id="validationCustomUsername" type="text" required="">
																		...
																		<div id="link">
																			<div class="row" >
																				<div class="col-xl-3 col-sm-7">
																					<input class="form-control" name="link[0][judul_link]" id="validationCustomUsername" placeholder="Text Tombol" type="text" required="" value="{{ old('link[0][judul_link]') ? old('link[0][judul_link]') : '' }}">
																				</div>
																				<div class="col-xl-4 col-sm-7">
																					<input class="form-control" name="link[0][link]" id="validationCustomUsername" placeholder="Link Tujuan" type="text" required="" value="{{ old('link[0][judul_link]') ? old('link[0][judul_link]') : '' }}">
																				</div>
																				<div class="col-xl-3 col-sm-7">
																...
																<div class="offset-xl-3 offset-sm-4 mt-4">
																	<button type="submit" name="simpan" class="btn btn-primary" onclick="loading()" id="submitLoading">
																		@if(isset($id))
																		Change
																		@else
																		Add
				...
				<script type="text/javascript">
					var warna = {{ isset($produk) ? $produk->warna->count() : 0 }};
					var size = {{ isset($produk) ? $produk->ukuran->count() : 0 }};
        ...
        <div class="col-xl-3 col-sm-7">
        <input class="form-control" name="warna[${warna}][gambar_warna]" id="validationCustomUsername" type="file" @if(!isset($produk)) required @endif>
        </div>
        <div class="col-xl-2 col-sm-7">
    ...
    function btn_image() {
        ...
        <input class="upload" name="gambar_produk[${countImage}][gambar]" type="file" onchange="preview_image('output_image[${countImage}]', event)" style="width:100px; height:100px;  z-index: 999; cursor:pointer;"><i class="fa fa-plus" style="position: absolute;"></i>
        </div>
        </li>
        ...
        <div class="box-input-file" style="width: 100px; height:100px;">
        <img id="output_image[${countImage}]" name="foto_produk[]" src="{{ asset('assets/images/400x400-image.jpg')  }}" style="width:100px; height:100px;">
        <input class="upload" name="gambar_produk[${countImage}]" type="file" onchange="preview_image('output_image[${countImage}]', event)" style="width:100px; height:100px;  z-index: 999; cursor:pointer;"><i class="fa fa-plus" style="position: absolute;"></i>
        </div>
        </li>
        </div>`; //New input field html 
        @endif
    ...
    function loading(){
    	document.getElementById('submitLoading').innerHTML = '<img src="{{ asset('assets/gif/loading.gif') }}">'
    }
</script>
<x-slot name="js">
