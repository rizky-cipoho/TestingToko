              ...
              <form class="form-inline search-form search-box">
                <div class="form-group">
                  <input class="form-control-plaintext" type="search" placeholder="Search..">
                        ...
                        @if(Auth::user()->with('role')->first()->role->bannerCreate == 'aktif')
                ...
                <table class="table all-package table-category " id="editableTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td data-field="name">{{ $banner->judul_id }}</td>
                      <td data-field="name">{{ $banner->judul_en }}</td>
                      <td data-field="name">{{ $banner->gambar }}</td>
                      <td data-field="name">{{ $banner->link }}</td>
                      <td style="display:flex; justify-content:center">
                        @if(Auth::user()->with('role')->first()->role->bannerEdit == 'aktif')
                        <a data-bs-target="#editModal" data-bs-toggle="modal" data-original-title="test" onclick="datasModal({{ $banner }}, '{{ route("home.banner.edit.proses", $banner->id) }}')">
                          <i class="fa fa-edit" title="Edit"></i>
                        </a>
                        @endif
                        @if(Auth::user()->with('role')->first()->role->bannerdelete == 'aktif')
                        <form method="post" action="{{ route('home.banner.delete.proses', $banner->id) }}">
                          @csrf
                          <button>
                            <a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form class="needs-validation" method="POST" action="{{ route('home.banner.add.proses') }}" enctype='multipart/form-data'>
          @csrf
